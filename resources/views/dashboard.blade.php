                        ...
                        <div class="bg-white  relative shadow-md sm:rounded-lg overflow-hidden">
                            <div
                                ...
                                <div
                                    ...
                                    <button type="button"
                                        class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2  :bg-primary-700 focus:outline-none :ring-primary-800">
                                    ...
                                    <div class="flex items-center space-x-3 w-full md:w-auto">
                                        <button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown"
                                            class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 :ring-gray-700    :text-white :bg-gray-700"
                                            type="button">
                                        ...
                                        <div id="actionsDropdown"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 "
                                                ...
                                                <li>
                                                    <a href="#"
                                                        class="block py-2 px-4 hover:bg-gray-100 :bg-gray-600 :text-white">Mass
                                                        Edit</a>
                                                </li>
                                            </ul>
                                            <div class="py-1">
                                                <a href="#"
                                                    class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 :bg-gray-600  :text-white">Delete
                                                    all</a>
                                            </div>
                                        </div>
                                        ...
                                        <div id="filterDropdown"
                                            ...
                                            <h6 class="mb-3 text-sm font-medium text-gray-900 ">Choose
                                                brand</h6>
                                        ...
                                        <tr class="border-b ">
                                            ...
                                            <td class="px-4 py-3 flex items-center justify-end">
                                                <button id="apple-imac-27-dropdown-button"
                                                    ...
                                                    class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none  :text-gray-100"
                                                    type="button">
                                                ...
                                                <div id="apple-imac-27-dropdown"
                                                    ...
                                                    <ul class="py-1 text-sm text-gray-700 "
                                                        ...
                                                        <li>
                                                            <a href="#"
                                                                class="block py-2 px-4 hover:bg-gray-100 :bg-gray-600 :text-white">Show</a>
                                                        </li>
                                                        <li>
                                                            <a href="#"
                                                                class="block py-2 px-4 hover:bg-gray-100 :bg-gray-600 :text-white">Edit</a>
                                                        </li>
                                                    </ul>
                                                    <div class="py-1">
                                                        <a href="#"
                                                            class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 :bg-gray-600  :text-white">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                                ...
                                <ul class="inline-flex items-stretch -space-x-px">
                                    <li>
                                        <a href="#"
                                            class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700    :bg-gray-700 :text-white">
                                    ...
                                    <li>
                                        <a href="#"
                                            class="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700    :bg-gray-700 :text-white">1</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700    :bg-gray-700 :text-white">2</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#"
                                            class="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700    :bg-gray-700 :text-white">...</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700    :bg-gray-700 :text-white">100</a>
                                    </li>
                                    <li>
                                        <a href="#"
